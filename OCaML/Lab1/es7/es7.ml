 ...
 *)
 ...
 module Calculator = PolishCalculator.Calculator (StackImpl.Stack);;

let expr  = "( 3 + 4 ) / -1 + 3  ";;

Printf.printf "L'espressione %s e' uguale a %d\n" expr  (Calculator.evaluate (Calculator.exp_of_string expr )) ;;
